...
const TRANSLATIONS = {
  home: {
    ...
    text: [
      ...
      [".timeline-column:nth-child(2) .timeline__item:nth-child(3) p:nth-child(3)", "National Inspirational Scholarship; Shandong Outstanding Student; Notice of exemption from tuition fees for gifted students.", "国家励志奖学金；山东省优秀学生；优秀学生学费减免通知。"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(3) p:nth-child(4)", "Issued by University of Konstanz, May 2026.", "由康斯坦茨大学颁发，2026 年 5 月。"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(4) .timeline__meta", "Competitions", "竞赛"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(4) h4", "Technical Competitions", "技术竞赛"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(4) p:nth-child(3)", "Huawei Kunpeng Innovation Competition, Provincial 2nd Prize; Lanqiao Cup, National Excellence; AI Competition, Provincial Prize.", "华为鲲鹏创新大赛省级二等奖；蓝桥杯全国优秀奖；AI 竞赛省级奖项。"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(5) .timeline__meta", "Publication", "论文"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(5) h4", "Lightweight Insulator Defect Detection Algorithm Based on UAV Perspective", "基于无人机视角的轻量化绝缘子缺陷检测算法"],
      [".timeline-column:nth-child(2) .timeline__item:nth-child(5) p:nth-child(3)", "Published in Journal of Beijing University of Aeronautics and Astronautics, 2025.", "发表于《北京航空航天大学学报》，2025。"],
      [".blog h2", "Blog", "博客"],
